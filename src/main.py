...
while(True): 
    ...
    jsonObj = systemGrow.createJsonObj(systemGrow.controlUnitId, systemGrow.ledStatus, systemGrow.temperature, systemGrow.pH, systemGrow.ppm, systemGrow.hum, systemGrow.createdAt);
