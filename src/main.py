...
while(True): 
    ...
    print(jsonObj)
    post = requests.post(url = 'http://p5023.dev.inited.cz/api/test/', json = {systemGrow.controlUnitId,systemGrow.ledStatus,systemGrow.temperature,systemGrow.ph,systemGrow.ec,systemGrow.hum,"2022-07-23T13:21:37.000Z"},headers=headers)
